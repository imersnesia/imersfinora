# iMersFinora v1.12 — Functional Core

Premium Personal & Family Finance PWA.

## Existing v1.12 installation
Run once: `supabase/upgrade/UPGRADE_v1.12_TO_v1.12.sql`, then replace the web source and redeploy.
